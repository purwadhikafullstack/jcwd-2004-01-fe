...
const MobileHeader = ({firstProp, secondProp, thirdProp, fourthProp, classExtend, secondPropClassExtend}) => {
    ...
    return (
        <div className={`container-mobile-header ${classExtend}`}>
            ...
            {fourthProp ? <Link href=""><div className="icon-mobile-header">{fourthProp}</div></Link> : null}
        </div>
    );
}
