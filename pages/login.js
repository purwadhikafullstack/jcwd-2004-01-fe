...
const Login = ({ loginAction }) => {
    ...
    const formik = useFormik({
        ...
        validationSchema : Yup.object({
            name : Yup.string().max(25, "Must contain 25 characters or less").required("Required").matches(/^\S*$/, "Should not contain spaces"), 
    ...
    return (
        ...
        <div className="flex">
            ...
            <div>
                <form className="w-[375px] h-fit lg:w-[720px] flex flex-col items-center mx-8 lg:mx-0" onSubmit={formik.handleSubmit}>
                    ...
                    <div className="w-[327px] lg:w-[528px] text-2xl font-bold lg:hidden">Masuk</div>
                    <div className="w-[327px] lg:w-[528px] text-2xl font-bold hidden lg:inline-block lg:mt-14">Masuk</div>
                    ...
                    <div className="w-[327px] lg:w-[528px] pt-8">
                        <Button type="submit" w="full" h="48px" variant={"fillCustom"}>Masuk</Button>
                    </div>
                    ...
                    <div className="items-center w-[528px] mt-10 hidden lg:flex justify-between">
                        <div><img src={lineDesktop} alt=""/></div>
                    ...
                    <div className="mt-10">
                        <div className="lg:hidden">
                            <Button type="button" w="327px" h="48px" variant={"outlineCustom"} leftIcon={<div className="text-2xl"><FcGoogle/></div>}>Google</Button>
                        </div>
                        <div className="hidden lg:inline-block">
                            <Button type="button" w="528px" h="48px" variant={"outlineCustom"} leftIcon={<div className="text-2xl"><FcGoogle/></div>}>Google</Button>
                        </div>
                    </div>

                    <p className="mt-10 pb-10 lg:pb-0">Belum punya akun? <Link href=""><span className="hover:cursor-pointer font-bold">Daftar</span></Link></p>
                </form>
            </div>
        </div>
    );
